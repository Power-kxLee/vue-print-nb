...
var printarea_default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function previewBox() {
      ...
      previewContent.setAttribute('id', "previewBox");
      previewContent.setAttribute('style', 'position: fixed;top: 0px;left: 0px;width: 100%;height: 100%;background: white;');
      document.querySelector('html').setAttribute('style', 'overflow: hidden;'); // 打印预览弹窗的header
      ...
      close.src = './images/print-icon.png';
    ...
    value: function Iframe(url) {
      ...
      try {
        ...
        if (!this.settings.preview) {
          ...
          // 预览打印
          this.previewBox().appendChild(iframe);
        }
