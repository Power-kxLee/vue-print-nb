...
var printarea_default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    value: function previewBox() {
      ...
      previewContent.setAttribute("style', 'position: fixed;top: 0px;left: 0px;width: 100%;height: 100%;background: white;display:none;z-index: ".concat(this.settings.zIndex, ";")); // 打印预览弹窗的header
